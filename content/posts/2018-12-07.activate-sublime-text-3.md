...
- [OS X](https://download.sublimetext.com/Sublime+Text+Build+3176.dmg) (10.7 or later is required)
- [Linux Repositories](https://www.sublimetext.com/docs/3/linux_repositories.html)
- [Windows 32-bit](https://download.sublimetext.com/Sublime+Text+Build+3176+Setup.exe) &ndash; [Portable Version](https://download.sublimetext.com/Sublime+Text+Build+3176.zip)
- [Windows 64-bit](https://download.sublimetext.com/Sublime+Text+Build+3176+x64+Setup.exe) &ndash; [Portable Version](https://download.sublimetext.com/Sublime+Text+Build+3176+x64.zip)
