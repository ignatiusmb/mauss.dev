...
4. Navigate to Interfacing Options and enable the VNC server
    |---|
    |![Raspberry Pi Main Config](images/posts/raspi.guide-to-plex-media-server-with-raspberry-pi.raspi-config-main.jpg)|
    |![Raspberry Pi Interfacing Config](images/posts/raspi.guide-to-plex-media-server-with-raspberry-pi.raspi-config-interfacing.jpg)|
    |![Raspberry Pi VNC Config](images/posts/raspi.guide-to-plex-media-server-with-raspberry-pi.raspi-config-vnc.jpg)|
