...
![Cluttered commits](images/posts/ppl2020.cluttered-merge-request-commits.png)
...
1. Start by setting your default branch and set them to protected
    ...
    ![GitLab protected branches](images/posts/ppl2020.gitlab-protected-branches.png)
...
3. Set the MR settings to *delete source after merge*, *squash commits by default*, *pipelines must succeed*, and *all discussions must be resolved*
    ...
    ![GitLab merge options and check](images/posts/ppl2020.merge-request-settings.png)
...
4. (Ignore if you're working individually) Set your MR approvals to at least 2 people
    ...
    ![GitLab merge request approvals](images/posts/ppl2020.merge-request-approvals.png)
