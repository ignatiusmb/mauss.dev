...
This is probably by far my favourite picture that describes git commit messages in a nutshell. It sums up most of our experience using and seeing git commits by ourselves or with our team.
...
4. Keeping your default (master) branch clean
...
1. Start by setting your default branch and set them to protected
    ...
    ![GitLab protected branches](posts/ppl2020.gitlab-protected-branches.png)
