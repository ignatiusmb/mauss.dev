...
<Article path={data.source} post={data.article}>
	...
	<section data-info="warning" style:margin-bottom="1rem">
		<!-- prettier-ignore -->
		<p><em><a href="/help#reviews-how-i-review">intentionally</a> written without synopsis or summary. these are my thoughts; for more context, see the <a href="/fine-print">fine print</a>.</em></p>
	</section>
