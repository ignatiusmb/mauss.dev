...
<style>
	...
	i[data-icon] {
		&[data-icon='download'] {
			--svg: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"><path d="M184,128h40a8,8,0,0,1,8,8v64a8,8,0,0,1-8,8H32a8,8,0,0,1-8-8V136a8,8,0,0,1,8-8H72"/><line x1="128" y1="24" x2="128" y2="128"/><polyline points="80 80 128 128 176 80"/><circle cx="188" cy="168" r="12"/></svg>');
		}
		&[data-icon='file-archive'] {
			--svg: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"><polyline points="152 32 152 88 208 88"/><path d="M200,224a8,8,0,0,0,8-8V88L152,32H56a8,8,0,0,0-8,8V216a8,8,0,0,0,8,8Z"/><line x1="104" y1="224" x2="104" y2="112"/><line x1="88" y1="160" x2="120" y2="160"/><line x1="88" y1="128" x2="120" y2="128"/><line x1="88" y1="192" x2="120" y2="192"/></svg>');
		}
	}
</style>
