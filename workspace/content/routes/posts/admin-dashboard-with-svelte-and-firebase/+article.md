...
![Sapper logo](https://sapper.svelte.dev/sapper-logo-horizontal.svg)
...
```text file:SSR Project Structure
src
├── components
│   ├── BackButton.svelte
│   ├── ListItem.svelte
...
```text file:SPA Project Structure
src
├── components
│   ├── BackButton.svelte
│   ├── ListItem.svelte
...
```svelte file:kasus/index.svelte
