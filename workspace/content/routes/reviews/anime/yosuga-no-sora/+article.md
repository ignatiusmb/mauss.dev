...
<div style="display: grid; grid-template-columns: repeat(7, 1fr); grid-template-rows: repeat(10, 1fr); text-align: center;">
    <span style="grid-area:1/4/2/5; padding: 0.25em 0; border: 3px solid var(--color-text);">
    1
    </span>
    <span style="grid-area:2/3/3/4;position:relative;">
        <!-- Horizontal Bar -->
        <span style="width:100%;position:absolute;top:50%;left:0;border:0.25px solid var(--color-text);"></span>
    </span>
    <span style="grid-area:2/4/3/5;position:relative;">
        <!-- Upper Vertical Bar -->
        <span style="height:50%;position:absolute;border:0.25px solid var(--color-text);"></span>
        <!-- Horizontal Bar -->
        <span style="width:100%;position:absolute;top:50%;left:0;border:0.25px solid var(--color-text);"></span>
    </span>
    ...
    <span style="grid-area:2/2/3/3; padding: 0.25em 0; border: 3px solid var(--color-text);">
    2
    </span>
    <span style="grid-area:3/1/4/2;position:relative;">
        <!-- Bottom Vertical Bar -->
        <span style="height:50%;position:absolute;bottom:0;border:0.25px solid var(--color-text);"></span>
        <!-- Right Horizontal Bar -->
        <span style="width:50%;position:absolute;top:50%;right:0;border:0.25px solid var(--color-text);"></span>
    </span>
    ...
    <span style="grid-area:3/3/4/4;position:relative;">
        <!-- Left Horizontal Bar -->
        <span style="width:50%;position:absolute;top:50%;left:0;border:0.25px solid var(--color-text);"></span>
        <!-- Bottom Vertical Bar -->
        <span style="height:50%;position:absolute;bottom:0;border:0.25px solid var(--color-text);"></span>
    </span>
    <span style="grid-area:2/6/3/7; padding: 0.25em 0; border: 3px solid var(--color-text);">
    7
    </span>
    ...
    <span style="grid-area:4/1/5/2; padding: 0.25em 0; border: 3px solid var(--color-text);">
    3
    </span>
    <span style="grid-area:5/1/5/2;position:relative;">
        <!-- Vertical Bar -->
        <span style="height:100%;position:absolute;border:0.25px solid var(--color-text);"></span>
    </span>
    <span style="grid-area:6/1/7/2; padding: 0.25em 0; border: 3px solid var(--color-text);">
    4
    </span>
    <span style="grid-area:4/3/5/4; padding: 0.25em 0; border: 3px solid var(--color-text);">
    5
    </span>
    ...
    <span style="grid-area:6/3/7/4; padding: 0.25em 0; border: 3px solid var(--color-text);">
    6
    </span>
    <span style="grid-area:4/5/5/6; padding: 0.25em 0; border: 3px solid var(--color-text);">
    8
    </span>
    ...
    <span style="grid-area:6/5/7/6; padding: 0.25em 0; border: 3px solid var(--color-text);">
    9
    </span>
    <span style="grid-area:4/7/5/8; padding: 0.25em 0; border: 3px solid var(--color-text);">
    10
    </span>
    ...
    <span style="grid-area:6/7/7/8; padding: 0.25em 0; border: 3px solid var(--color-text);">
    11
    </span>
    ...
    <span style="grid-area:8/7/9/8; padding: 0.25em 0; border: 3px solid var(--color-text);">
    12
    </span>
    <span style="grid-area:10/1/11/2; padding: 0.25em 0; border: 3px solid var(--color-text);">
    Kazuha
    </span>
    <span style="grid-area:10/3/11/4; padding: 0.25em 0; border: 3px solid var(--color-text);">
    Akira
    </span>
    <span style="grid-area:10/5/11/6; padding: 0.25em 0; border: 3px solid var(--color-text);">
    Nao
    </span>
    <span style="grid-area:10/7/11/8; padding: 0.25em 0; border: 3px solid var(--color-text);">
    Sora
    </span>
</div>
